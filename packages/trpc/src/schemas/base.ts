...
// Base ID schemas - accept both CUID and nanoid formats
export const ruleIdSchema = z.string().min(1);
export const ruleVersionIdSchema = z.string().min(1);
export const userIdSchema = z.string().min(1);
export const commentIdSchema = z.string().min(1);
export const claimIdSchema = z.string().min(1);
...
export const handleSchema = z
  ...
  .regex(
    /^[a-z0-9_-]+$/,
    "Handle must contain only lowercase letters, numbers, underscores, and hyphens"
  );
