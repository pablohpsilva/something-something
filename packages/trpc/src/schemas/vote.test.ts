...
describe("Vote Schemas", () => {
  ...
  describe("voteScoreQuerySchema", () => {
    ...
    it("should validate ruleVersionId when provided", () => {
      ...
      expect(() =>
        voteScoreQuerySchema.parse(validVersionIdInput)
      ).not.toThrow();
    ...
    it("should handle undefined values", () => {
      ...
      expect(() =>
        voteScoreQuerySchema.parse(inputWithUndefined)
      ).not.toThrow();
    });
  });
  ...
  describe("userVotesQuerySchema", () => {
    ...
    it("should accept valid input with ruleVersionIds only", () => {
      const validInput = {
        ruleVersionIds: [
          "clkv6q4a40000356h2g8h2g8k",
          "clkv6q4a40000356h2g8h2g8l",
        ],
      };
    ...
    it("should validate ruleVersionIds array elements", () => {
      ...
      expect(() =>
        userVotesQuerySchema.parse(validVersionIdsInput)
      ).not.toThrow();
      ...
      expect(() =>
        userVotesQuerySchema.parse(invalidVersionIdsInput)
      ).toThrow();
    });
    ...
    it("should handle undefined values", () => {
      ...
      expect(() =>
        userVotesQuerySchema.parse(inputWithUndefined)
      ).not.toThrow();
    });
  });
  ...
  describe("userVotesResponseSchema", () => {
    ...
    it("should accept decimal vote values", () => {
      ...
      expect(() =>
        userVotesResponseSchema.parse(decimalResponse)
      ).not.toThrow();
    });
    ...
    it("should reject non-numeric vote values", () => {
      ...
      expect(() =>
        userVotesResponseSchema.parse(invalidRuleVotesResponse)
      ).toThrow();
      ...
      expect(() =>
        userVotesResponseSchema.parse(invalidVersionVotesResponse)
      ).toThrow();
    });
  ...
  describe("Edge Cases and Integration", () => {
    ...
    it("should handle batch voting queries", () => {
      ...
      expect(() =>
        userVotesResponseSchema.parse(largeBatchResponse)
      ).not.toThrow();
    });
    ...
    it("should handle mixed vote scenarios", () => {
      ...
      expect(() =>
        userVotesResponseSchema.parse(mixedVotesResponse)
      ).not.toThrow();
    });
  });
});
