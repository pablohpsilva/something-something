...
describe("Leaderboard Schemas", () => {
  ...
  describe("getLeaderboardHistorySchema", () => {
    ...
    it("should validate limit constraints", () => {
      ...
      expect(() => getLeaderboardHistorySchema.parse(minLimitInput)).not.toThrow()
      ...
      expect(() => getLeaderboardHistorySchema.parse(maxLimitInput)).not.toThrow()
      ...
      expect(() => getLeaderboardHistorySchema.parse(invalidMinInput)).toThrow()
      ...
      expect(() => getLeaderboardHistorySchema.parse(invalidMaxInput)).toThrow()
    })
  ...
  describe("Edge Cases and Integration", () => {
    ...
    it("should handle history query with maximum limit", () => {
      ...
      expect(() => getLeaderboardHistorySchema.parse(maxHistoryInput)).not.toThrow()
    })
      ...
      periods.forEach(period => {
        scopes.forEach(scope => {
          ...
          if (scope !== "GLOBAL") {
            ...
            ;(input as any).scopeRef = scope === "TAG" ? "test-tag" : "test-model"
          }
    ...
    it("should handle boundary values for limits", () => {
      ...
      expect(() => getLeaderboardSchema.parse(minLeaderboardInput)).not.toThrow()
      ...
      expect(() => getLeaderboardSchema.parse(maxLeaderboardInput)).not.toThrow()
      ...
      expect(() => getLeaderboardHistorySchema.parse(minHistoryInput)).not.toThrow()
    ...
    it("should handle long scopeRef values", () => {
      ...
      expect(() => getLeaderboardSchema.parse(inputWithLongScopeRef)).not.toThrow()
      expect(() => getUserRankSchema.parse(inputWithLongScopeRef)).not.toThrow()
      expect(() => getLeaderboardHistorySchema.parse(inputWithLongScopeRef)).not.toThrow()
      expect(() => generateSnapshotSchema.parse(inputWithLongScopeRef)).not.toThrow()
    })
    ...
    it("should handle empty string scopeRef", () => {
      ...
      expect(() => getLeaderboardSchema.parse(inputWithEmptyScopeRef)).not.toThrow()
    })
    ...
    it("should validate that all schemas use consistent period and scope enums", () => {
      ...
      expect(() => getAvailableScopesSchema.parse({ period: testPeriod })).not.toThrow()
    })
  })
})
