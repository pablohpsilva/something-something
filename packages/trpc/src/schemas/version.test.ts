...
describe("Version Schemas", () => {
  describe("createVersionSchema", () => {
    ...
    it("should accept input without baseVersionId", () => {
      ...
      expect(() => createVersionSchema.parse(inputWithoutBaseVersion)).not.toThrow()
    })
    ...
    it("should accept input without testedOn", () => {
      ...
      expect(() => createVersionSchema.parse(inputWithoutTestedOn)).not.toThrow()
    })
    ...
    it("should accept input without version (auto-increment)", () => {
      ...
      expect(() => createVersionSchema.parse(inputWithoutVersion)).not.toThrow()
    })
    ...
    it("should accept input without idempotencyKey", () => {
      ...
      expect(() => createVersionSchema.parse(inputWithoutIdempotencyKey)).not.toThrow()
    })
    ...
    it("should validate baseVersionId (CUID) when provided", () => {
      ...
      expect(() => createVersionSchema.parse(validBaseVersionInput)).not.toThrow()
  ...
  describe("forkVersionSchema", () => {
    ...
    it("should accept input without idempotencyKey", () => {
      ...
      expect(() => forkVersionSchema.parse(inputWithoutIdempotencyKey)).not.toThrow()
    })
  ...
  describe("listVersionsByRuleSchema", () => {
    ...
    it("should accept input without cursor", () => {
      ...
      expect(() => listVersionsByRuleSchema.parse(inputWithoutCursor)).not.toThrow()
    })
    ...
    it("should validate integer limit", () => {
      ...
      expect(() => listVersionsByRuleSchema.parse(invalidIntegerInput)).toThrow()
    })
    ...
    it("should validate ruleId (CUID)", () => {
      ...
      expect(() => listVersionsByRuleSchema.parse(validRuleIdInput)).not.toThrow()
    ...
    it("should require ruleId", () => {
      ...
      expect(() => listVersionsByRuleSchema.parse(inputWithoutRuleId)).toThrow()
    })
  })
  ...
  describe("getVersionByIdSchema", () => {
    ...
    it("should validate versionId (CUID)", () => {
      ...
      expect(() => getVersionByIdSchema.parse(validVersionIdInput)).not.toThrow()
  ...
  describe("updateVersionSchema", () => {
    ...
    it("should accept input without testedOn", () => {
      ...
      expect(() => updateVersionSchema.parse(inputWithoutTestedOn)).not.toThrow()
    })
    ...
    it("should accept input without idempotencyKey", () => {
      ...
      expect(() => updateVersionSchema.parse(inputWithoutIdempotencyKey)).not.toThrow()
    })
    ...
    it("should validate versionId (CUID)", () => {
      ...
      expect(() => updateVersionSchema.parse(validVersionIdInput)).not.toThrow()
  ...
  describe("setCurrentVersionSchema", () => {
    ...
    it("should accept input without idempotencyKey", () => {
      ...
      expect(() => setCurrentVersionSchema.parse(inputWithoutIdempotencyKey)).not.toThrow()
    })
    ...
    it("should validate ruleId and versionId (CUIDs)", () => {
      ...
      expect(() => setCurrentVersionSchema.parse(emptyVersionIdInput)).toThrow()
    })
  ...
  describe("getVersionHistorySchema", () => {
    ...
    it("should accept input without cursor", () => {
      ...
      expect(() => getVersionHistorySchema.parse(inputWithoutCursor)).not.toThrow()
    })
    ...
    it("should validate integer limit", () => {
      ...
      expect(() => getVersionHistorySchema.parse(invalidIntegerInput)).toThrow()
    })
    ...
    it("should validate ruleId (CUID)", () => {
      ...
      expect(() => getVersionHistorySchema.parse(validRuleIdInput)).not.toThrow()
  ...
  describe("compareVersionsSchema", () => {
    ...
    it("should validate version IDs (CUIDs)", () => {
      ...
      expect(() => compareVersionsSchema.parse(emptyBaseVersionInput)).toThrow()
      ...
      expect(() => compareVersionsSchema.parse(emptyCompareVersionInput)).toThrow()
    })
  ...
  describe("getVersionStatsSchema", () => {
    ...
    it("should validate versionId (CUID)", () => {
      ...
      expect(() => getVersionStatsSchema.parse(validVersionIdInput)).not.toThrow()
    ...
    it("should require versionId", () => {
      ...
      expect(() => getVersionStatsSchema.parse(inputWithoutVersionId)).toThrow()
    })
  })
  ...
  describe("Edge Cases and Integration", () => {
    it("should handle complex version management scenarios", () => {
      ...
      const complexCreateInput = {
        ...
        testedOn: {
          models: ["gpt-4", "gpt-4-turbo", "claude-3-opus", "claude-3-sonnet", "claude-3-haiku"],
    ...
    it("should handle comprehensive version workflow", () => {
      ...
      expect(() => setCurrentVersionSchema.parse(setCurrentInput)).not.toThrow()
