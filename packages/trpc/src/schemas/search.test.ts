...
describe("Search Schemas", () => {
  ...
  describe("searchResultResponseSchema", () => {
    ...
    it("should accept empty results", () => {
      ...
      expect(() => searchResultResponseSchema.parse(emptyResponse)).not.toThrow()
    })
    ...
    it("should accept null values for optional fields", () => {
      ...
      expect(() => searchResultResponseSchema.parse(responseWithNulls)).not.toThrow()
    })
    ...
    it("should validate required fields", () => {
      ...
      requiredFields.forEach(field => {
        ...
        expect(() => searchResultResponseSchema.parse(invalidResponse)).toThrow()
      })
    })
  })
  ...
  describe("searchStatsResponseSchema", () => {
    ...
    it("should accept null lastUpdated", () => {
      ...
      expect(() => searchStatsResponseSchema.parse(responseWithNullDate)).not.toThrow()
    })
    ...
    it("should validate integer totalIndexed", () => {
      ...
      expect(() => searchStatsResponseSchema.parse(invalidIntegerResponse)).toThrow()
    })
    ...
    it("should require all fields", () => {
      ...
      requiredFields.forEach(field => {
        ...
        expect(() => searchStatsResponseSchema.parse(invalidResponse)).toThrow()
      })
    })
  })
  ...
  describe("searchOperationResponseSchema", () => {
    ...
    it("should accept response with only message", () => {
      ...
      expect(() => searchOperationResponseSchema.parse(responseWithMessage)).not.toThrow()
    })
    ...
    it("should accept response with only count", () => {
      ...
      expect(() => searchOperationResponseSchema.parse(responseWithCount)).not.toThrow()
    })
    ...
    it("should validate integer count", () => {
      ...
      expect(() => searchOperationResponseSchema.parse(invalidCountResponse)).toThrow()
    })
    ...
    it("should require success field", () => {
      ...
      expect(() => searchOperationResponseSchema.parse(responseWithoutSuccess)).toThrow()
    })
  })
  ...
  describe("advancedFiltersSchema", () => {
    ...
    it("should accept all valid sortBy values", () => {
      const sortByValues = ["relevance", "date", "score", "trending", "title"] as const
  ...
  describe("searchFacetsResponseSchema", () => {
    ...
    it("should accept empty facets", () => {
      ...
      expect(() => searchFacetsResponseSchema.parse(emptyResponse)).not.toThrow()
    })
    ...
    it("should validate integer counts", () => {
      ...
      expect(() => searchFacetsResponseSchema.parse(invalidCountResponse)).toThrow()
    })
    ...
    it("should require all facet fields", () => {
      ...
      requiredFields.forEach(field => {
        ...
        expect(() => searchFacetsResponseSchema.parse(invalidResponse)).toThrow()
      })
    })
    ...
    it("should validate tag facet structure", () => {
      ...
      expect(() => searchFacetsResponseSchema.parse(validTagFacet)).not.toThrow()
    })
    ...
    it("should validate model facet structure", () => {
      ...
      expect(() => searchFacetsResponseSchema.parse(validModelFacet)).not.toThrow()
    })
    ...
    it("should validate author facet structure", () => {
      ...
      expect(() => searchFacetsResponseSchema.parse(validAuthorFacet)).not.toThrow()
    })
    ...
    it("should validate content type facet structure", () => {
      ...
      expect(() => searchFacetsResponseSchema.parse(validContentTypeFacet)).not.toThrow()
    })
  })
  ...
  describe("Edge Cases and Integration", () => {
    it("should handle complex search scenarios", () => {
      const complexSearchInput = {
        ...
        filters: {
          tags: ["javascript", "typescript", "testing", "framework", "jest", "vitest"],
    ...
    it("should handle comprehensive response structures", () => {
      ...
      expect(() => searchResultResponseSchema.parse(comprehensiveResponse)).not.toThrow()
    })
    ...
    it("should handle facet responses with various counts", () => {
      ...
      expect(() => searchFacetsResponseSchema.parse(facetVariations)).not.toThrow()
    })
    ...
    it("should validate all schemas work together in a search flow", () => {
      ...
      expect(() => searchResultResponseSchema.parse(searchResponse)).not.toThrow()
