...
describe("Social Schemas", () => {
  describe("toggleFollowInputSchema", () => {
    ...
    it("should require authorUserId", () => {
      ...
      expect(() =>
        toggleFollowInputSchema.parse(inputWithoutAuthorUserId)
      ).toThrow();
    });
  });
  ...
  describe("listFollowersInputSchema", () => {
    ...
    it("should accept input without cursor", () => {
      ...
      expect(() =>
        listFollowersInputSchema.parse(inputWithoutCursor)
      ).not.toThrow();
    });
    ...
    it("should validate integer limit", () => {
      ...
      expect(() =>
        listFollowersInputSchema.parse(invalidIntegerInput)
      ).toThrow();
    });
    ...
    it("should require authorUserId", () => {
      ...
      expect(() =>
        listFollowersInputSchema.parse(inputWithoutAuthor)
      ).toThrow();
    });
  });
  ...
  describe("listFollowingInputSchema", () => {
    ...
    it("should accept input without cursor", () => {
      ...
      expect(() =>
        listFollowingInputSchema.parse(inputWithoutCursor)
      ).not.toThrow();
    });
    ...
    it("should validate integer limit", () => {
      ...
      expect(() =>
        listFollowingInputSchema.parse(invalidIntegerInput)
      ).toThrow();
    });
  ...
  describe("notificationsListInputSchema", () => {
    ...
    it("should accept input without cursor", () => {
      ...
      expect(() =>
        notificationsListInputSchema.parse(inputWithoutCursor)
      ).not.toThrow();
    });
    ...
    it("should validate limit constraints", () => {
      ...
      expect(() =>
        notificationsListInputSchema.parse(minLimitInput)
      ).not.toThrow();
      ...
      expect(() =>
        notificationsListInputSchema.parse(maxLimitInput)
      ).not.toThrow();
      ...
      expect(() =>
        notificationsListInputSchema.parse(invalidMinInput)
      ).toThrow();
      ...
      expect(() =>
        notificationsListInputSchema.parse(invalidMaxInput)
      ).toThrow();
    });
    ...
    it("should validate integer limit", () => {
      ...
      expect(() =>
        notificationsListInputSchema.parse(invalidIntegerInput)
      ).toThrow();
    });
    ...
    it("should reject invalid filter", () => {
      ...
      expect(() =>
        notificationsListInputSchema.parse(invalidFilterInput)
      ).toThrow();
    });
  });
  ...
  describe("deleteNotificationInputSchema", () => {
    ...
    it("should accept any non-empty string (cuidOrUuidSchema)", () => {
      ...
      expect(() =>
        deleteNotificationInputSchema.parse(validInput)
      ).not.toThrow();
    });
    ...
    it("should require id", () => {
      ...
      expect(() =>
        deleteNotificationInputSchema.parse(inputWithoutId)
      ).toThrow();
    });
  });
  ...
  describe("followResponseSchema", () => {
    ...
    it("should accept zero counts", () => {
      ...
      expect(() =>
        followResponseSchema.parse(zeroCountsResponse)
      ).not.toThrow();
    });
    ...
    it("should validate integer counts", () => {
      ...
      expect(() =>
        followResponseSchema.parse(invalidFollowersCountResponse)
      ).toThrow();
      ...
      expect(() =>
        followResponseSchema.parse(invalidFollowingCountResponse)
      ).toThrow();
    });
  ...
  describe("watchResponseSchema", () => {
    ...
    it("should accept zero watchers count", () => {
      ...
      expect(() =>
        watchResponseSchema.parse(zeroWatchersResponse)
      ).not.toThrow();
    });
    ...
    it("should validate integer watchers count", () => {
      ...
      expect(() =>
        watchResponseSchema.parse(invalidWatchersCountResponse)
      ).toThrow();
    });
  ...
  describe("followersListResponseSchema", () => {
    ...
    it("should accept empty followers list", () => {
      ...
      expect(() =>
        followersListResponseSchema.parse(emptyResponse)
      ).not.toThrow();
    });
    ...
    it("should accept response without nextCursor", () => {
      ...
      expect(() =>
        followersListResponseSchema.parse(responseWithoutCursor)
      ).not.toThrow();
    });
    ...
    it("should accept followers without isVerified field", () => {
      ...
      expect(() =>
        followersListResponseSchema.parse(responseWithoutVerified)
      ).not.toThrow();
    });
    ...
    it("should accept null avatarUrl", () => {
      ...
      expect(() =>
        followersListResponseSchema.parse(responseWithNullAvatar)
      ).not.toThrow();
    });
    ...
    it("should validate integer totalCount", () => {
      ...
      expect(() =>
        followersListResponseSchema.parse(invalidTotalCountResponse)
      ).toThrow();
    });
    ...
    it("should require all main fields", () => {
      ...
      requiredFields.forEach((field) => {
        ...
        expect(() =>
          followersListResponseSchema.parse(invalidResponse)
        ).toThrow();
      });
    });
  ...
  describe("followingListResponseSchema", () => {
    ...
    it("should accept empty following list", () => {
      ...
      expect(() =>
        followingListResponseSchema.parse(emptyResponse)
      ).not.toThrow();
    });
    ...
    it("should accept response without nextCursor", () => {
      ...
      expect(() =>
        followingListResponseSchema.parse(responseWithoutCursor)
      ).not.toThrow();
    });
    ...
    it("should accept following without isVerified field", () => {
      ...
      expect(() =>
        followingListResponseSchema.parse(responseWithoutVerified)
      ).not.toThrow();
    });
    ...
    it("should accept null avatarUrl", () => {
      ...
      expect(() =>
        followingListResponseSchema.parse(responseWithNullAvatar)
      ).not.toThrow();
    });
    ...
    it("should validate integer totalCount", () => {
      ...
      expect(() =>
        followingListResponseSchema.parse(invalidTotalCountResponse)
      ).toThrow();
    });
    ...
    it("should require all main fields", () => {
      ...
      requiredFields.forEach((field) => {
        ...
        expect(() =>
          followingListResponseSchema.parse(invalidResponse)
        ).toThrow();
      });
    });
  ...
  describe("notificationsListResponseSchema", () => {
    ...
    it("should accept all valid notification types", () => {
      ...
      notificationTypes.forEach((type) => {
        ...
        expect(() =>
          notificationsListResponseSchema.parse(response)
        ).not.toThrow();
      });
    });
    ...
    it("should reject invalid notification type", () => {
      ...
      expect(() =>
        notificationsListResponseSchema.parse(invalidTypeResponse)
      ).toThrow();
    });
    ...
    it("should accept empty notifications list", () => {
      ...
      expect(() =>
        notificationsListResponseSchema.parse(emptyResponse)
      ).not.toThrow();
    });
    ...
    it("should accept response without nextCursor", () => {
      ...
      expect(() =>
        notificationsListResponseSchema.parse(responseWithoutCursor)
      ).not.toThrow();
    });
    ...
    it("should accept notifications without optional fields", () => {
      ...
      expect(() =>
        notificationsListResponseSchema.parse(minimalNotificationResponse)
      ).not.toThrow();
    });
    ...
    it("should accept null readAt (unread notification)", () => {
      ...
      expect(() =>
        notificationsListResponseSchema.parse(unreadNotificationResponse)
      ).not.toThrow();
    });
    ...
    it("should accept actor with null avatarUrl", () => {
      ...
      expect(() =>
        notificationsListResponseSchema.parse(actorWithNullAvatarResponse)
      ).not.toThrow();
    });
    ...
    it("should validate integer counts", () => {
      ...
      expect(() =>
        notificationsListResponseSchema.parse(invalidTotalCountResponse)
      ).toThrow();
      ...
      expect(() =>
        notificationsListResponseSchema.parse(invalidUnreadCountResponse)
      ).toThrow();
    });
    ...
    it("should require all main fields", () => {
      ...
      requiredFields.forEach((field) => {
        ...
        expect(() =>
          notificationsListResponseSchema.parse(invalidResponse)
        ).toThrow();
      });
    });
  ...
  describe("unreadCountResponseSchema", () => {
    ...
    it("should accept zero count", () => {
      ...
      expect(() =>
        unreadCountResponseSchema.parse(zeroCountResponse)
      ).not.toThrow();
    });
    ...
    it("should validate integer count", () => {
      ...
      expect(() =>
        unreadCountResponseSchema.parse(invalidCountResponse)
      ).toThrow();
    });
    ...
    it("should require count field", () => {
      ...
      expect(() =>
        unreadCountResponseSchema.parse(responseWithoutCount)
      ).toThrow();
    });
  });
  ...
  describe("markReadResponseSchema", () => {
    ...
    it("should require success field", () => {
      ...
      expect(() =>
        markReadResponseSchema.parse(responseWithoutSuccess)
      ).toThrow();
    });
  });
  ...
  describe("markManyReadResponseSchema", () => {
    ...
    it("should accept zero updated count", () => {
      ...
      expect(() =>
        markManyReadResponseSchema.parse(zeroUpdatedResponse)
      ).not.toThrow();
    });
    ...
    it("should validate integer updated count", () => {
      ...
      expect(() =>
        markManyReadResponseSchema.parse(invalidUpdatedResponse)
      ).toThrow();
    });
    ...
    it("should require updated field", () => {
      ...
      expect(() =>
        markManyReadResponseSchema.parse(responseWithoutUpdated)
      ).toThrow();
    });
  });
  ...
  describe("deleteNotificationResponseSchema", () => {
    ...
    it("should accept response with false success", () => {
      ...
      expect(() =>
        deleteNotificationResponseSchema.parse(failureResponse)
      ).not.toThrow();
    });
    ...
    it("should require success field", () => {
      ...
      expect(() =>
        deleteNotificationResponseSchema.parse(responseWithoutSuccess)
      ).toThrow();
    });
  });
  ...
  describe("Edge Cases and Integration", () => {
    it("should handle complex social interaction scenarios", () => {
      ...
      expect(() =>
        toggleFollowInputSchema.parse(complexFollowInput)
      ).not.toThrow();
      ...
      expect(() =>
        toggleWatchInputSchema.parse(complexWatchInput)
      ).not.toThrow();
      ...
      expect(() =>
        notificationsListInputSchema.parse(complexNotificationsInput)
      ).not.toThrow();
    });
    ...
    it("should handle comprehensive response structures", () => {
        ...
        items: [
          {
            ...
            avatarUrl:
              "https://cdn.example.com/avatars/comprehensive-follower-1.jpg",
            isVerified: true,
      ...
      expect(() =>
        followersListResponseSchema.parse(comprehensiveFollowersResponse)
      ).not.toThrow();
        ...
        items: [
          {
            ...
            message:
              "You received a $50.00 donation with a message: Keep up the great work!",
            ...
            actor: {
              ...
              avatarUrl:
                "https://cdn.example.com/avatars/comprehensive-donor.jpg",
            },
          },
          {
            ...
            message:
              "Your authorship claim has been approved by the review team",
      ...
      expect(() =>
        notificationsListResponseSchema.parse(
          comprehensiveNotificationsResponse
        )
      ).not.toThrow();
    });
    ...
    it("should validate all schemas work together in a social flow", () => {
      ...
      expect(() =>
        listFollowersInputSchema.parse(followersInput)
      ).not.toThrow();
      ...
      expect(() =>
        followersListResponseSchema.parse(followersResponse)
      ).not.toThrow();
      ...
      expect(() =>
        notificationsListInputSchema.parse(notificationsInput)
      ).not.toThrow();
      ...
      expect(() =>
        notificationsListResponseSchema.parse(notificationsResponse)
      ).not.toThrow();
      ...
      expect(() =>
        markReadResponseSchema.parse(markReadResponse)
      ).not.toThrow();
    });
  });
});
