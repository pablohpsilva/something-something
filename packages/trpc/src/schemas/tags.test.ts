...
describe("Tags Schemas", () => {
  ...
  describe("attachTagsSchema", () => {
    ...
    it("should accept input without idempotencyKey", () => {
      ...
      expect(() => attachTagsSchema.parse(inputWithoutIdempotencyKey)).not.toThrow()
    })
  })
  ...
  describe("detachTagsSchema", () => {
    ...
    it("should accept input without idempotencyKey", () => {
      ...
      expect(() => detachTagsSchema.parse(inputWithoutIdempotencyKey)).not.toThrow()
    })
  })
  ...
  describe("createTagSchema", () => {
    ...
    it("should accept input without description", () => {
      ...
      expect(() => createTagSchema.parse(inputWithoutDescription)).not.toThrow()
    })
    ...
    it("should accept input without idempotencyKey", () => {
      ...
      expect(() => createTagSchema.parse(inputWithoutIdempotencyKey)).not.toThrow()
    })
  })
  ...
  describe("updateTagSchema", () => {
    ...
    it("should accept input without idempotencyKey", () => {
      ...
      expect(() => updateTagSchema.parse(inputWithoutIdempotencyKey)).not.toThrow()
    })
  })
  ...
  describe("getTagSuggestionsSchema", () => {
    ...
    it("should accept input without excludeExisting", () => {
      ...
      expect(() => getTagSuggestionsSchema.parse(inputWithoutExclude)).not.toThrow()
    })
    ...
    it("should validate integer limit", () => {
      ...
      expect(() => getTagSuggestionsSchema.parse(invalidIntegerInput)).toThrow()
    })
    ...
    it("should validate excludeExisting slugs", () => {
      ...
      expect(() => getTagSuggestionsSchema.parse(validExcludeInput)).not.toThrow()
      ...
      expect(() => getTagSuggestionsSchema.parse(invalidExcludeInput)).toThrow()
      ...
      expect(() => getTagSuggestionsSchema.parse(emptyExcludeInput)).not.toThrow()
    })
  ...
  describe("Edge Cases and Integration", () => {
    ...
    it("should handle comprehensive tag operations workflow", () => {
      ...
      expect(() => getTagSuggestionsSchema.parse(suggestionsInput)).not.toThrow()
