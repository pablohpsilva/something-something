...
describe("Metrics Schemas", () => {
  ...
  describe("getVersionMetricsSchema", () => {
    ...
    it("should require ruleVersionId", () => {
      ...
      expect(() => getVersionMetricsSchema.parse(inputWithoutVersionId)).toThrow()
    })
  ...
  describe("getAuthorMetricsSchema", () => {
    ...
    it("should require authorId", () => {
      ...
      expect(() => getAuthorMetricsSchema.parse(inputWithoutAuthorId)).toThrow()
    })
  ...
  describe("Edge Cases and Integration", () => {
    ...
    it("should handle metrics queries with full date ranges", () => {
      ...
      expect(() => getVersionMetricsSchema.parse(versionMetricsInput)).not.toThrow()
      expect(() => getAuthorMetricsSchema.parse(authorMetricsInput)).not.toThrow()
      expect(() => getPlatformMetricsSchema.parse(platformMetricsInput)).not.toThrow()
    })
    ...
    it("should handle boundary values for trending content", () => {
      ...
      expect(() => getTrendingContentSchema.parse(minTrendingInput)).not.toThrow()
      expect(() => getTrendingContentSchema.parse(maxTrendingInput)).not.toThrow()
    })
    ...
    it("should handle granularity consistency across schemas", () => {
      ...
      commonGranularities.forEach(granularity => {
        ...
        if (granularity !== "month") {
          expect(() => getOpenMetricsSchema.parse(openMetricsInput)).not.toThrow()
        }
        expect(() => getRuleMetricsSchema.parse(ruleMetricsInput)).not.toThrow()
        expect(() => getAuthorMetricsSchema.parse(authorMetricsInput)).not.toThrow()
        expect(() => getPlatformMetricsSchema.parse(platformMetricsInput)).not.toThrow()
