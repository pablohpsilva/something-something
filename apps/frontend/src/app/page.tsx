          ...
          {rulesQuery.data?.items && rulesQuery.data.items.length > 0 && (
            <div className="grid gap-6">
              ...
              {rulesQuery.data.items.map((rule) => (
                <Link key={rule.id} href={`/rule/${rule.slug}`}>
                  <article className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-6 hover:shadow-lg transition-shadow cursor-pointer">
